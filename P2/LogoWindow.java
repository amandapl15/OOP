...
public class LogoWindow extends javax.swing.JFrame {
    ...
    public LogoWindow() {
        ...
        prog.addInstruction("FWD" , 25) ;
        prog.addInstruction("ROT" , 270 ) ;
        ...
        prog.addInstruction("PEN" , 1) ;
        prog.addInstruction("ROT" , 270 ) ;
        prog.addInstruction("FWD" , 35) ;
        prog.addInstruction("ROT" , 180 ) ;
        prog.addInstruction("FWD" , 35) ;
        prog.addInstruction("ROT" , 270 ) ;
        prog.addInstruction("PEN" , 0) ;
        prog.addInstruction("FWD" , 50) ;
        prog.addInstruction("ROT" , 270 ) ;
        prog.addInstruction("PEN" , 1) ;
        prog.addInstruction("FWD" , 35) ;
        prog.addInstruction("PEN" , 0) ;
        prog.addInstruction("FWD" , 10) ;
        prog.addInstruction("ROT" , 270 ) ;
        prog.addInstruction("FWD" , 25) ;
        prog.addInstruction("ROT" , 90 ) ;
        initComponents();
        setSize(this.logo.getWidth(), this.logo.getHeight());
    }
